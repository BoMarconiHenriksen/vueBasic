                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 form-group">
                    <label for="store">
                        <input
                                ...
                                id="store"
                                value="Store"
                                v-model="storeInDatabase"> Store in Database
                    </label>
                    <label for="dontStore">
                        <input
                                type="radio"
                                id="dontStore"
                                value="DontStore"
                                v-model="storeInDatabase"> Do not Store in Database
                    </label>
                </div>
            </div>

            <!-- Exercise 2 Display the Data Summary ONCE the Form HAS been submitted -->
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    <button

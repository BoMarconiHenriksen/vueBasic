### Exercises conditionals and rendering
html  
```
...
<div id="exercise">
  ...
  <div>
    ...
    <p v-if="hidden">You either see me ...</p>
    <p v-else="hidden">...or me</p>
    ...
    <p v-show="hidden">You either see me with show ...</p>
    <p v-show="!hidden">...or me with show</p>
